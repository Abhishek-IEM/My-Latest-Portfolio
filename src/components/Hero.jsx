...
const socials = [
  { icon: FaGithub, label: "GitHub", href: "https://github.com/Abhishek-IEM" },
  {
    icon: FaLinkedin,
    label: "LinkedIn",
    href: "https://www.linkedin.com/in/abhishek-sharma-63901a283/",
  },
  {
    icon: SiLeetcode,
    label: "LeetCode",
    href: "https://leetcode.com/u/Abhishek090602/",
  },
  {
    icon: SiGeeksforgeeks,
    label: "GFG",
    href: "https://www.geeksforgeeks.org/profile/as611vndq",
  },
];
      ...
      <div className="max-w-6xl mx-auto w-full grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <motion.div
            ...
            className="text-xl md:text-2xl font-medium text-gray-600 dark:text-gray-300 h-14"
          >
            <TypeAnimation
              sequence={[
          ...
          <motion.p
            variants={itemVariants}
            className="text-gray-500 dark:text-gray-400 max-w-xl leading-relaxed"
          >
            Computer Science and Engineering (IoT) graduate from IEM Kolkata,
            passionate about building scalable web applications and integrating
              ...
              <div className="w-full h-full rounded-2xl bg-gradient-to-br from-primary-600 via-primary-500 to-accent flex items-center justify-center overflow-hidden">
                ...
                <div className="text-white/90 font-mono text-sm p-6 space-y-2">
                  ...
                  <div className="pl-4">
                    ...
                    <span className="text-yellow-300">'Abhishek'</span>,
                  </div>
                  <div className="pl-4">
                  ...
                  <div className="pl-4">
                    <span className="text-primary-200">stack:</span>{" "}
                    <span className="text-yellow-300">'MERN'</span>,
                  </div>
                  <div className="pl-4">
                    <span className="text-primary-200">cgpa:</span>{" "}
                    <span className="text-green-300">8.94</span>,
                  </div>
                  <div className="pl-4">
                    <span className="text-primary-200">passion:</span>{" "}
